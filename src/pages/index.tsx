        ...
        <div className='bg-gray-300 bg-opacity-75'>
          <div className='container flex flex-col items-start min-h-screen px-64 mx-auto overflow-hidden text-black'>
            ...
            <p className='mt-8 text-lg'>
              <span className='font-bold'>Fast Feedback</span> is the easiest
              way to add comments or reviews to your static site. It's still a
              work-in-progress, but you can try it out by leaving a comment
              below.
            </p>
            <div>
